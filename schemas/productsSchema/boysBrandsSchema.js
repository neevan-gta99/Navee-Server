...
const boysBrandsSchema = new mongoose.Schema({
...
boysBrandsSchema.pre("save", async function (next) {
...
export const boysBrandsDTO = mongoose.models.boysBrands || mongoose.model("boysBrands", boysBrandsSchema);
