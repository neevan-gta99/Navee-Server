...
const womensWASchema = new mongoose.Schema({
...
womensWASchema.pre("save", async function (next) {
...
export const womensWADTO = mongoose.models.womensWASchema || mongoose.model("womensWA", womensWASchema);
