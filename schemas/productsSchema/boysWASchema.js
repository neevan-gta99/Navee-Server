...
const boysWASchema = new mongoose.Schema({
...
boysWASchema.pre("save", async function (next) {
...
export const boysWADTO = mongoose.models.boysWASchema || mongoose.model("boysWA", boysWASchema);
