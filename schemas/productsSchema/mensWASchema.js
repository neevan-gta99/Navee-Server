...
const mensWASchema = new mongoose.Schema({
...
mensWASchema.pre("save", async function (next) {
...
export const mensWADTO = mongoose.models.mensWASchema || mongoose.model("mensWA", mensWASchema);
