...
const singleUploads = async function (req, res, next) {
  const folderName = req.body.collection || "Uncategorized";
  const subFolderName = req.body.subCategory || req.body.gender;
  ...
  const productId = await ID_Generator.getNextId(all_Codes.productCode[withoutSpacedProCategory], withoutSpacedProCategory);
...
const singleProductImageUploader = { singleUploads, sellerRegisterUploads }
